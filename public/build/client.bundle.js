...
_reactDom2.default.hydrate(_react2.default.createElement(_app2.default, null), container);
...
*/
var aa=__webpack_require__(12),ba=__webpack_require__(0),m=__webpack_require__(37),p=__webpack_require__(16),v=__webpack_require__(13),da=__webpack_require__(38),ea=__webpack_require__(39),fa=__webpack_require__(40),ha=__webpack_require__(17);
...
var _ToDoApp = __webpack_require__(73);
...
var _ToDoForm = __webpack_require__(113);

var _ToDoForm2 = _interopRequireDefault(_ToDoForm);

var _ToDoList = __webpack_require__(114);

var _ToDoList2 = _interopRequireDefault(_ToDoList);

var _ToDoFooter = __webpack_require__(115);

var _ToDoFooter2 = _interopRequireDefault(_ToDoFooter);

var _ToDoStyles = __webpack_require__(20);

var _ToDoStyles2 = _interopRequireDefault(_ToDoStyles);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var uuidv1 = __webpack_require__(116);
...
var ToDoApp = function (_React$Component) {
  ...
  function ToDoApp() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ToDoApp.__proto__ || (0, _getPrototypeOf2.default)(ToDoApp)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      todo: 'first',
      todoList: [],
      checks: [],
      option: 'all',
      ...
      _this.setState({
        todoList: _this.state.todoList.concat({
          id: uuidv1(),
          todo: task,
          bool: false
        })
      ...
      var todoList = _this.state.todoList.filter(function (todo) {
        return todo.id !== id;
      });
      _this.setState({ todoList: todoList });
    }, _this.checkTodo = function (task, id, bool) {
      //check which item in the array it is
      var arr = _this.state.todoList;
      ...
      if (bool) {
        _this.setState({
          checks: _this.state.checks.concat({
            id: id,
            todo: task,
            bool: bool
          })
        ...
        var checkList = _this.state.checks.filter(function (check) {
          return check.id !== id;
        });
        _this.setState({
          checks: checkList,
    ...
    }, _this.showOption = function (option) {
      if (option === 'all') {
        _this.setState({
          option: 'all'
        });
      ...
      var todos = _this.state.todoList;
      for (var i in todos) {
        todos[i].bool = _this.state.status;
      }
    ...
    }, _this.comparer = function (otherArray) {
      ...
      var withOutCheck = _this.state.todoList.filter(function (mask) {
        return mask.bool == true;
      });
      var onlyInTodos = _this.state.todoList.filter(_this.comparer(withOutCheck));
      var onlyInWOA = withOutCheck.filter(_this.comparer(_this.state.todoList));
      var newArr = onlyInTodos.concat(onlyInWOA);
      _this.setState({
        todoList: newArr,
        checks: []
      });
  ...
  (0, _createClass3.default)(ToDoApp, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { style: _ToDoStyles2.default.body },
        _react2.default.createElement(
          'div',
          { style: _ToDoStyles2.default.wrapper },
          _react2.default.createElement(
            'div',
            { style: _ToDoStyles2.default.app },
            _react2.default.createElement(_ToDoForm2.default, { addTodo: this.addTodo, checkAll: this.checkAll }),
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(44)(Function.call, __webpack_require__(57).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var ToDoForm = function (_React$Component) {
  (0, _inherits3.default)(ToDoForm, _React$Component);
  ...
  function ToDoForm() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ToDoForm.__proto__ || (0, _getPrototypeOf2.default)(ToDoForm)).call.apply(_ref, [this].concat(args))), _this), _this.keyPress = function (e) {
      if (e.keyCode == 13) {
        e.preventDefault();
        _this.props.addTodo(e.target.value);
      }
    }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', {
            id: 'input',
            style: _ToDoStyles2.default.todoInput,
            type: 'text',
        ...
        _react2.default.createElement(
          'button',
          {
            style: _ToDoStyles2.default.footerFilters.button,
            onClick: function onClick() {
              return _this2.props.checkAll();
            }
          },
          'Check all'
        )
...
function ToDoItem(props) {
  return _react2.default.createElement(
    'li',
    { className: 'todo-item', style: _ToDoStyles2.default.todoItem },
    _react2.default.createElement('input', {
      checked: props.todo.bool,
      type: 'checkbox',
      style: _ToDoStyles2.default.todoItemCheckBox,
    ...
    _react2.default.createElement(
      'button',
      {
        ...
        style: _ToDoStyles2.default.todoItemDelete,
        defaultChecked: true,
        onClick: function onClick() {
          return props.deleteItem(props.todo.id);
        }
      },
      'X'
    )
...
function ToDoList(props) {
  var renderArr = props.todos;
  if (props.option === 'all') {
    renderArr = props.todos;
  } else if (props.option === 'complete') {
    renderArr = props.checks;
  } else {
    var onlyInTodos = props.todos.filter(props.comparer(props.checks));
    var onlyInChecks = props.checks.filter(props.comparer(props.todos));
    renderArr = onlyInTodos.concat(onlyInChecks);
  }
  return _react2.default.createElement(
    'ul',
    null,
    renderArr.slice(0).reverse().map(function (todo, index) {
...
function ToDoFooter(_ref) {
  var todos = _ref.todos,
      clearComplete = _ref.clearComplete,
      showOption = _ref.showOption;

  var cnt = todos.filter(function (todo) {
    return todo.bool == false;
  });
  return _react2.default.createElement(
    'div',
    { style: _ToDoStyles2.default.footer.container },
    _react2.default.createElement(
      'p',
      { style: _ToDoStyles2.default.footer.itemsLeft },
      cnt.length,
      ' items left'
    ),
    _react2.default.createElement(ToDoFooterFilters, { showOption: showOption }),
    _react2.default.createElement(
      'button',
      {
        style: _ToDoStyles2.default.footerFilters.button,
...
function ToDoFooterFilters(_ref2) {
  var showOption = _ref2.showOption;

  return _react2.default.createElement(
    'div',
    { style: _ToDoStyles2.default.footerFilters.container },
    _react2.default.createElement(
      'button',
      {
        style: _ToDoStyles2.default.footerFilters.button,
        onClick: function onClick() {
          return showOption('all');
        }
      },
      'All'
    ),
